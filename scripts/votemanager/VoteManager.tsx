      ...
      <div>
        ...
        <Container>
          <div className="form-horizontal my-2">
            ...
            />
            <div className="divider" />
            <p>When finished, send your changes to Lisk Nano or Lisk Hub by clicking the buttons below in sequence. You will get an overview of the votes you are sending in Lisk Hub before you actually submit the votes:</p>
