...
export default class VoteManagerControls extends Component<any, any> {
  ...
  setSelectedToRadical() {
    const payoutRadical = _.uniq([...groups.gdt.data, ...groups.shw.data, ...groups.builders.data, ...groups.lig.data, ...groups.ascend.data, ...groups.dutchpool.data, ...groups.indi.data, "4fryn", "5an1ty", "acheng", "adrianhunter", "alepop", "anamix", "augurproject", "badman0316", "bioly", "bloqspace.io", "carbonara", "carolina", "cc001", "chamberlain", "communitypool", "corsaro", "crodam", "crolisk", "dakk", "devasive", "diamse", "eastwind_ja", "eclipsun", "elevate", "endro", "forger_of_lisk", "forrest", "gdtpool", "goldeneye", "gr33ndrag0n", "grajsondelegate", "grumlin", "hagie", "hirish", "hmachado", "honeybee", "iii.element.iii", "joel", "joo5ty", "kushed.delegate", "leo", "liberspirita", "liskascend", "liskgate", "liskit", "liskjp", "liskpoland.pl", "liskpool.top", "liskpool_com_01", "liskpro.com", "loveforever", "luxiang7890", "minions", "moosty", "mrgr", "mrv", "nerigal", "nimbus", "ntelo", "ondin", "panzer", "philhellmuth", "phinx", "phoenix1969", "punkrock", "redsn0w", "robinhood", "samuray", "savetheworld", "seven", "sgdias", "shinekami", "slamper", "slasheks", "spacetrucker", "splatters", "stellardynamic", "tembo", "thepool", "tonyt908", "vekexasia", "vi1son", "vipertkd", "vrlc92", "ultrafresh", "moracle.network"]);
    this.closeModal('wizard');
    this.props.store.setSelectedDelegates(payoutRadical);
  }

  setSelectedToDestroy() {
    const payoutDestroy = _.uniq([...groups.gdt.data, ...groups.shw.data, ...groups.builders.data, ...groups.lig.data, ...groups.ascend.data, ...groups.dutchpool.data, ...groups.indi.data, "4fryn", "5an1ty", "alepop", "anamix", "0", "bioly", "bloqspace.io", "carbonara", "cc001", "communitypool", "corsaro", "dakk", "devasive", "diamse", "eclipsun", "elevate", "endro", "forrest", "gdtpool", "goldeneye", "gr33ndrag0n", "grumlin", "hagie", "hirish", "hmachado", "joel", "joo5ty", "kushed.delegate", "liberspirita", "liskascend", "liskgate", "liskit", "liskpoland.pl", "liskpool.top", "liskpool_com_01", "liskpro.com", "loveforever", "minions", "moosty", "mrv", "nerigal", "nimbus", "ntelo", "ondin", "philhellmuth", "phoenix1969", "punkrock", "redsn0w", "robinhood", "samuray", "sgdias", "sherwood", "shinekami", "slamper", "slasheks", "splatters", "stellardynamic", "tembo", "thepool", "tonyt908", "vekexasia", "vi1son", "vipertkd", "vrlc92", "ultrafresh", "moracle.network"]);
    this.closeModal('wizard');
