...
export default class VoteManagerControls extends Component<any, any> {
  ...
  setSelectedToModerate() {
    const payoutModerate = _.uniq([...groups.builders.data, ...groups.gdt.data, ...groups.shw.data, "4fryn", "5an1ty", "acheng", "adrianhunter", "alepop", "anamix", "augurproject", "badman0316", "bigtom", "bioly", "blackswan", "bloqspace.io", "carbonara", "carolina", "cc001", "chamberlain", "communitypool", "corsaro", "crodam", "crolisk", "dakk", "devasive", "diamse", "eastwind_ja", "eclipsun", "elevate", "elonhan", "endro", "forger_of_lisk", "forrest", "gdtpool", "goldeneye", "goodtimes", "gr33ndrag0n", "grajsondelegate", "grumlin", "hagie", "hirish", "hmachado", "honeybee", "hua", "iii.element.iii", "jixie", "joel", "joo5ty", "kushed.delegate", "leo", "liberspirita", "liskascend", "liskgate", "liskit", "liskjp", "liskpoland.pl", "liskpool.top", "liskpool_com_01", "liskpro.com", "liskroad", "loveforever", "luiz", "luxiang7890", "mac", "minions", "moosty", "moracle.network", "mrgr", "mrv", "nerigal", "nimbus", "ntelo", "ondin", "panzer", "philhellmuth", "phinx", "phoenix1969", "punkrock", "redsn0w", "robinhood", "samuray", "savetheworld", "seven", "sgdias", "shinekami", "slamper", "slasheks", "someonesomeone", "spacetrucker", "splatters", "stellardynamic", "tembo", "thepool", "tonyt908", "ultrafresh", "vekexasia", "veriform", "vi1son", "vipertkd", "vrlc92", "will", "xujian", "zy1349"]);
    this.closeModal('wizard');
    this.props.store.setSelectedDelegates(payoutModerate);
  }

  setSelectedToRadical() {
    const payoutRadical = _.uniq([...groups.ascend.data, ...groups.builders.data, ...groups.dutchpool.data, ...groups.gdt.data, ...groups.indi.data, ...groups.lig.data, ...groups.shw.data, "4fryn", "5an1ty", "acheng", "adrianhunter", "alepop", "anamix", "augurproject", "badman0316", "bioly", "bloqspace.io", "carbonara", "carolina", "cc001", "chamberlain", "communitypool", "corsaro", "crodam", "crolisk", "dakk", "devasive", "diamse", "eastwind_ja", "eclipsun", "elevate", "endro", "forger_of_lisk", "forrest", "gdtpool", "goldeneye", "gr33ndrag0n", "grajsondelegate", "grumlin", "hagie", "hirish", "hmachado", "honeybee", "iii.element.iii", "joel", "joo5ty", "kushed.delegate", "leo", "liberspirita", "liskascend", "liskgate", "liskit", "liskjp", "liskpoland.pl", "liskpool.top", "liskpool_com_01", "liskpro.com", "loveforever", "luxiang7890", "minions", "moosty", "moracle.network", "mrgr", "mrv", "nerigal", "nimbus", "ntelo", "ondin", "panzer", "philhellmuth", "phinx", "phoenix1969", "punkrock", "redsn0w", "robinhood", "samuray", "savetheworld", "seven", "sgdias", "shinekami", "slamper", "slasheks", "spacetrucker", "splatters", "stellardynamic", "tembo", "thepool", "tonyt908", "ultrafresh", "vekexasia", "vi1son", "vipertkd", "vrlc92"]);
    this.closeModal('wizard');
    this.props.store.setSelectedDelegates(payoutRadical);
  }

  setSelectedToDestroy() {
    const payoutDestroy = _.uniq([...groups.ascend.data, ...groups.builders.data, ...groups.dutchpool.data, ...groups.gdt.data, ...groups.indi.data, ...groups.lig.data, ...groups.shw.data, "0", "4fryn", "5an1ty", "alepop", "anamix", "bioly", "bloqspace.io", "carbonara", "cc001", "communitypool", "corsaro", "dakk", "devasive", "diamse", "eclipsun", "elevate", "endro", "forrest", "gdtpool", "goldeneye", "gr33ndrag0n", "grumlin", "hagie", "hirish", "hmachado", "joel", "joo5ty", "kushed.delegate", "liberspirita", "liskascend", "liskgate", "liskit", "liskpoland.pl", "liskpool.top", "liskpool_com_01", "liskpro.com", "loveforever", "minions", "moosty", "moracle.network", "mrv", "nerigal", "nimbus", "ntelo", "ondin", "philhellmuth", "phoenix1969", "punkrock", "redsn0w", "robinhood", "samuray", "sgdias", "sherwood", "shinekami", "slamper", "slasheks", "splatters", "stellardynamic", "tembo", "thepool", "tonyt908", "ultrafresh", "vekexasia", "vi1son", "vipertkd", "vrlc92"]);
    this.closeModal('wizard');
